              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2 justify-center lg:justify-start">
                ...
                >
                  <span className="relative z-10">
                    {isUserAuthenticated ? "Go to Dashboard" : "Get Started Free"}
                  </span>
                ...
                <Link
                  href="#features"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full font-medium text-slate-300 border transition-all hover:text-white hover:bg-white/5"
