...
import { userInterviews, availableInterviews } from "@/constants/interviews";
        ...
        <main className="container mx-auto py-10 px-4 md:px-8 space-y-12 animate-fade-in-up">
            ...
            <section className="space-y-5">
                <div className="flex items-end justify-between">
                    ...
                    <Link href="/feedback" className="text-sm text-muted-foreground hover:text-foreground inline-flex items-center gap-1">
